        ...
        <div className="gradient-background min-h-screen">
            <div className="max-w-6xl mx-auto py-12 px-6 text-white">
                ...
                <div className="bg-slate-800 p-6 rounded-lg mb-5">
                    ...
                    <p className="text-xl text-justify mb-4 font-body font-extrabold">A company website which recommends hosting packages</p>
                    <p className="text-justify font-body mb-4">
                        <span className="bg-gradient-to-r from-[#6C5CE7] to-[#60A5FA] bg-clip-text text-transparent font-bold">Hosting Recommender</span> is an internal company tool. This tool helps <span className="bg-gradient-to-r from-[#6C5CE7] to-[#60A5FA] bg-clip-text text-transparent font-bold">employees</span> find the right hosting package for customers, based on a few simple questions. Based on the answers on these questions, the correct package is recommended, along with pricing and technical specifications. This tool was built in a single day as an experiment, but is now being used throughout the entire company. The <span className="bg-gradient-to-r from-[#6C5CE7] to-[#60A5FA] bg-clip-text text-transparent font-bold">Front-End</span> was built using <span className="bg-gradient-to-r from-[#6C5CE7] to-[#60A5FA] bg-clip-text text-transparent font-bold">Vue.js</span>, the <span className="bg-gradient-to-r from-[#6C5CE7] to-[#60A5FA] bg-clip-text text-transparent font-bold">Back-End</span> uses <span className="bg-gradient-to-r from-[#6C5CE7] to-[#60A5FA] bg-clip-text text-transparent font-bold">Python</span>. If users do not understand a question or have additional questions, they can ask the <span className="bg-gradient-to-r from-[#6C5CE7] to-[#60A5FA] bg-clip-text text-transparent font-bold">chatbot</span> for help. This chatbot is powered using a model from <span className="bg-gradient-to-r from-[#6C5CE7] to-[#60A5FA] bg-clip-text text-transparent font-bold">OpenAI</span>.
                    </p>
                </div>
            </div>
        </div>
