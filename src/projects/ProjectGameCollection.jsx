        ...
        <div className="gradient-background min-h-screen">
            <div className="max-w-6xl mx-auto py-12 px-6 text-white">
                ...
                <div className="bg-slate-800 p-6 rounded-lg mb-5">
                    ...
                    <p className="text-justify font-body mb-4">The <span className="text-blue-400 font-bold">Full-Stack Game Collection</span> is one of the latest projects I have worked on. The goal of this project was to learn more about the differences between <span className="text-blue-400 font-bold">Front-End</span> and <span className="text-blue-400 font-bold">Back-End</span> webdevelopment. This project uses <span className="text-blue-400 font-bold">React.js</span> and <span className="text-blue-400 font-bold">Tailwind CSS</span> as the most important <span className="text-blue-400 font-bold">Front-End</span> components. The <span className="text-blue-400 font-bold">Back-End</span> consists of <span className="text-blue-400 font-bold">Node.js</span>, <span className="text-blue-400 font-bold">MongoDB</span>, and <span className="text-blue-400 font-bold">Express</span>. By combining the <span className="text-blue-400 font-bold">Front-End</span> and <span className="text-blue-400 font-bold">Back-End</span>, I have created a website that stores data of popular video games. The game data is stored by the <span className="text-blue-400 font-bold">Back-End</span> and retrieved and visualized by the <span className="text-blue-400 font-bold">Front-End</span>. Even though the final product itself doesn't look too spectacular, I think this project was one of the most educational projects I have worked on so far.</p>
