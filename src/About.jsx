        ...
        <div className="gradient-background min-h-screen">
            <div className="max-w-6xl mx-auto py-12 px-6 text-white">
                ...
                <div className="relative bg-slate-800/90 p-6 rounded-lg overflow-hidden">
                    <div className="font-body text-sm md:text-lg mb-5 px-3 leading-relaxed" style={{ textAlign: "justify" }}>
                    ...
                    <button className={`absolute bottom-2 right-2 p-2 rounded-full text-white transition ${animationComplete ? "bg-gray-500 cursor-default" : "bg-blue-600 hover:bg-blue-700"}`} onClick={() => { setSkipAnimation(true); setAnimationComplete(true); }} disabled={animationComplete}>
                        <RiSpeedLine className="text-xl" />
                    </button>
                </div>
                <div className="flex space-x-4 mt-4 max-md:flex-col max-md:space-x-0 max-md:gap-4">
                    <a href="https://github.com/Mathijs-04" target="_blank" className="group relative inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium text-gray-900 rounded-lg bg-gradient-to-br from-[#6C5CE7] via-[#A29BFE] to-[#D6CCFF] md:hover:text-white dark:text-white max-md:w-full">
                        <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md md:group-hover:bg-transparent md:group-hover:dark:bg-transparent flex items-center justify-center w-full"><FaGithub className="mr-2 text-lg" /> GitHub</span>
                    </a>
                    <a href="https://www.linkedin.com/in/mathijs-van-der-meijde-creative-developer/" target="_blank" className="group relative inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium text-gray-900 rounded-lg bg-gradient-to-br from-[#6C5CE7] via-[#A29BFE] to-[#D6CCFF] md:hover:text-white dark:text-white max-md:w-full">
                        <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md md:group-hover:bg-transparent md:group-hover:dark:bg-transparent flex items-center justify-center w-full"><FaLinkedin className="mr-2 text-lg" /> LinkedIn</span>
                    </a>
                </div>
            </div>
        </div>
