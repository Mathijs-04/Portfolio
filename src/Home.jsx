            ...
            <div className="text-center text-white">
                ...
                <div className="mt-12 flex justify-center gap-4 max-md:flex-col max-md:mt-8 max-md:gap-3 max-md:w-[60%] max-md:mx-auto">
                    {[
                        ...
                        >
                            <span className="relative px-10 py-2.5 transition-all ease-in duration-75 bg-gray-900 dark:bg-gray-900 rounded-md md:group-hover:bg-transparent md:group-hover:dark:bg-transparent w-full font-panchang font-bold text-[10px] max-md:px-4 h-12 flex items-center justify-center">{label}</span>
