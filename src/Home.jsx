    ...
    return (
        <div className="gradient-background min-h-[85vh] flex items-center justify-center">
            <div className="text-center text-white">
                ...
                <div className="mt-12 flex justify-center gap-4 max-md:flex-col max-md:mt-8 max-md:gap-3">
                    {[
                        ...
                        >
                            <span className="relative px-10 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md md:group-hover:bg-transparent md:group-hover:dark:bg-transparent w-full font-body font-bold max-md:px-4">{label}</span>
